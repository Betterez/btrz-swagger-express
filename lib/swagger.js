...
Swagger.prototype.convertModelsToOpenApi2 = function (models) {
  var self = this;
  ...
  _.forOwn(models, function (modelValue, key) {
    ...
    if (modelValue) {
      ...
      //convert oneOf to properties, to allow for OpenAPI 2 validation to work. (Should not need this for OpenAPI 3)
      if (modelValue.oneOf) {

        if (!modelValue.properties) {
          modelValue.properties = {};
        }

        _.forOwn(modelValue.oneOf, function (propValue, propKey) {

          //propValue becomes propKey, as I don't have anything else to use
          modelValue.properties[propValue] = { "$ref": propValue };
        });
        
        delete modelValue.oneOf;
      }
...
Swagger.prototype.addModels = function (models) {
  ...
  self.convertModelsToOpenApi2(models);
