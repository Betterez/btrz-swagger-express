...
Swagger.prototype.convertOperationToOpenApi2 = function (doc, operationValue, key) {
  ...
  doc.paths[p][method] = {
    ...
    "consumes": operationValue.consumes,
    "parameters": [],
    "responses": {}
  ...
  operationValue.errorResponses.forEach(function (response) {
    ...
    if (!doc.paths[p][method]["responses"][response.code]) {
      ...
      doc.paths[p][method]["responses"][response.code] = {
        "description": doc.paths[p][method]["responses"][response.code].description + "\n\n" + responseDescription
      }
    }
    ...
    if (response.responseModel && response.responseModel !== "string") {
      if (response.responseModel !== "file") {
        doc.paths[p][method]["responses"][response.code]["schema"] = {
    ...
    operationValue.parameters.forEach(function (param) {
      ...
      if (param.paramType === "body") {
        doc.paths[p][method]["parameters"].push({
          ...
          "schema": openApi2ConversionHelpers.getBodySchema(param)
        });
      }
      else if (param.paramType === "path" || param.paramType === "query" || param.paramType === "form") {
        let convertedParam = {
          "name": param.name,
          "in": (param.paramType === "form") ? "formData" : param.paramType,
          "description": param.description,
          "required": param.required,
          "type": param.type
        }
        ...
        doc.paths[p][method]["parameters"].push(convertedParam);
      }
    });
  }
};
...
Swagger.prototype.addMethod = function (app, callback, spec) {
  ...
  if (!spec.hideInDocumentation || self.runningInDev) {
    if (root && root.apis) {
      // this path already exists in swagger resource, or should be displayed (hideInDocumentation = false), or it is running in dev environment
