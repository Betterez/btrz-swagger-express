...
function appendNotesToDescription(description, notes) {
...
function convertOperationToOpenApi2(doc, operationValue, key) {
  ...
  doc.paths[pathName][method] = {
    ...
    "description": appendNotesToDescription(operationValue.description, operationValue.notes),
...
module.exports.appendNotesToDescription = appendNotesToDescription;
