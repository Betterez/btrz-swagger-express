...
"$ref": "#/definitions/Pet"
  ...
  */
  if (operationValue.parameters) {
    ...
    console.log("********************models*******************************");
    //console.log("key: ", key)
    console.dir(operationValue.parameters, { depth: null });
    console.log("********************models*******************************");
...
//transform the existing parameters into a Swagger 2 friendly format
Swagger.prototype.convertParametersToOpenApi2 = function (doc, paramValue, key) {
  var self = this;
  var p = operationValue.path;
  var method = operationValue.method.toLowerCase();
