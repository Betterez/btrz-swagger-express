...
var sortTags = resourceHelpers.sortTags;
...
Swagger.prototype.configure = function (bp, av, swaggerVersion) {
  ...
  console.log(`Configure swagger version::${swaggerVersion}`);
...
Swagger.prototype.addPropertiesToRequiredModels = function (properties, requiredModels) {
  var self = this;
  console.log("Inside Swagger.prototype.addPropertiesToRequiredModels");
