...
module.exports.convertOperationToOpenApi2 = convertOperationToOpenApi2;
...
function convertOperationToOpenApi2(doc, operationValue, key) {
  ...
  setResponses(doc.paths[p][method], operationValue);

  setParameters(doc.paths[p][method], operationValue);
}
